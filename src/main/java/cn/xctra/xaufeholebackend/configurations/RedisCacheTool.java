...
public class RedisCacheTool {
    ...
    @Bean
    @NotNull
    public CacheManager cacheManager(@NotNull RedisTemplate<String, Object> template) {
    ...
    @Bean(name = "template")
    @NotNull
    public RedisTemplate<String, Object> template(@NotNull RedisConnectionFactory factory) {
